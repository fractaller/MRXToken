...
interface TokenLockForPublicTestInterface extends ethers.utils.Interface {
  functions: {
...
export class TokenLockForPublicTest extends Contract {
  ...
  interface: TokenLockForPublicTestInterface;
