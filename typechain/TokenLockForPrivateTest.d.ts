...
interface TokenLockForPrivateTestInterface extends ethers.utils.Interface {
  functions: {
...
export class TokenLockForPrivateTest extends Contract {
  ...
  interface: TokenLockForPrivateTestInterface;
