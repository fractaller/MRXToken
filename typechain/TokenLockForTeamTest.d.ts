...
interface TokenLockForTeamTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "reassign(address,address)": FunctionFragment;
...
export class TokenLockForTeamTest extends Contract {
  ...
  interface: TokenLockForTeamTestInterface;
  ...
  callStatic: {
    ...
    destroy(receiver: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    destroy(receiver: string, overrides?: Overrides): Promise<BigNumber>;
