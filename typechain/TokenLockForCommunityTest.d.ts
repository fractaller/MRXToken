...
interface TokenLockForCommunityTestInterface extends ethers.utils.Interface {
  functions: {
...
export class TokenLockForCommunityTest extends Contract {
  ...
  interface: TokenLockForCommunityTestInterface;
