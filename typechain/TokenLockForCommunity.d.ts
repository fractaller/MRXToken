...
interface TokenLockForCommunityInterface extends ethers.utils.Interface {
  functions: {
...
export class TokenLockForCommunity extends Contract {
  ...
  interface: TokenLockForCommunityInterface;
